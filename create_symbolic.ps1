...
rm "C:\Users\8ucch\OneDrive\Documents\PowerShell\profile.ps1"
New-Item -Value "C:\Users\8ucch\dotfiles\windows\profile.ps1" -Path "C:\Users\8ucch\OneDrive\Documents\PowerShell" -Name profile.ps1 -ItemType SymbolicLink
